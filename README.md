...
### 4. Bitwise operations and PNG image with alpha channel
...
### 1. OpenCV GUI(HighGUI) in Python and Callbacks
...
### 2. Load and Save Video, and working with webcam, CCTV, and screenRecord in python
...
### 1. Thresholding
- [19-Thresholding-and-binarization.ipynb](https://nbviewer.org/github/Alireza-Akhavan/class.vision/blob/master/19-Thresholding-and-binarization.ipynb)
- [20-Otsu-binarization.ipynb](https://nbviewer.org/github/Alireza-Akhavan/class.vision/blob/master/20-Otsu-binarization.ipynb)
- [21-Adaptive-thresholding.ipynb](https://nbviewer.org/github/Alireza-Akhavan/class.vision/blob/master/21-Adaptive-thresholding.ipynb)
